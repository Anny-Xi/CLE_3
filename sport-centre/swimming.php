...
<main>
    <section class="sport-container">
        <div class="sport-image-box">
            <img class="sport-image" alt="Foto van een swimming goggles" src="photo-sport-centre/swimming-goggles-png-4.jpg">
        </div>
    ...
    <section class="sport-filters-container">
        <form id="filter-form">
            ...
            <input type="hidden" id="sport" value="swimming">
